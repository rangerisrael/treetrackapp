...
if (empty($_FILES["profile"]["name"])){
    ...
    $stmt=$db_conn->prepare('INSERT INTO security(username,pwd,nameofuser,profile,ip_users,mac_user,role_type,date_created,date_updated) VALUES (:user,:pass,:roles,:img,:ip,:mac,"ADMIN",NOW(),NOW())');
    $stmt->bindParam(':user', $usernames);
    $stmt->bindParam(':pass', $passcode);
    $stmt->bindParam(':roles', $rolename);

...
<button class="btn btn-danger float-right"><a href="logout.php">LOGOUT</a></button>
      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-12">
               <form action="editdata.php" name="form" method="POST" enctype="multipart/form-data">
    ...
    <!--  -->
                  ...
                  <!--  -->
                     ...
                     <b><label for="dba">TREE CATEGORY</label></b>
                      ...
                      <?php if($category=="planted"){
                        ...
                        <div style="display: none;" id="planted">
                            <b>DATE PLANTED</b>
                            <input  type="date" class="others" placeholder="date_planted"name="plant" id="plant" value="<?php echo $date_planted;?>">
                    ...
                    <div style="display: none; position:relative; left:-2vw;" id="natural">
                            <b>DATE DISCOVER</b>
                            <input  type="date" class="others" placeholder="date_discover"name="discover" id="nature" value="<?php echo $date_discover;?>">
                       
                    <?php 
                    }?>
                          <?php if($category=="natural"){?>
                   <div style="display: none; position:relative; left:-2vw;" id="natural">
                            <b>DATE DISCOVER</b><input  type="date" class="others" placeholder="date_discover"name="discover" id="nature">
                        </div>
                        <div style="display: none;" id="planted">
